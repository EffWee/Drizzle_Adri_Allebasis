...
RKI_Archiv_file = 'C:/Users/Florian/Documents/Corona/Fallzahl_Archiv/' + d.datetime.strftime(date_RKI_Archiv, '%Y%m%d') + '.csv'
        ...
        while day < evaluation.days - 7:
                ...
                if Path(RKI_Archiv_file).is_file():
                        ...
                        for row_i in csv_reader_RKI_Archiv:
                                if (row_i["Landkreis"] == lkq_dict[Id]["lk_plus"]):
...
##                        Err = 1
        ...
        csv_writer_LKQ.writerow({'ID-Landkreis': Id,
                                 ...
                                 '7-Tage-Inzidenz (tagesaktuell)': lkq_dict[Id]["STI_Actual"],
                                 'Meldequalität MQ': MQ_summe,
                                 'Mittelwert MQ_quer': MQ_quer})
